                    ...
                    <table>  
                        <thead>
                            <tr>
                                ...
                                <th rowspan="2" style="width:200px;">Learning and Teaching Methods</th>
            ...
            <tr>
                ...
                <td>
                    ...
                    <table>
                        <thead>
                            <tr>
                                <th rowspan="3" style="width:500px;">Course Content Outline</th>
                                <th rowspan="3">CO</th>
                                <th colspan="6">Teaching & Learning Activities</th>
                        ...
                        <tbody id="table-body">
                            @if($course)
                                ...
                                <tr>
                                    <td style="text-align:left; word-wrap: break-word;">{!! nl2br(e(str_replace(['{', '}'], '', $row->courseOutline))) !!}</td>
                                    <td>{{ $row->CO }}</td>
                                    <td>{{ $row->L }}</td>
                                    <td>{{ $row->T }}</td>
                                    <td>{{ $row->P }}</td>
